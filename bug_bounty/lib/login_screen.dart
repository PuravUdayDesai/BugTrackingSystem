...
class _LoginScreenState extends State<LoginScreen> {
  ...
  //     var response = await ApiCall.createRecord(Uri.GET_OWNER + "/login", map,
  //         authorization: false);
  //     print(response);
  ...
  //           Uri.GET_OWNER + "/${response['ownerId']}");
  //       print(r);
  //       OwnerModel owner = new OwnerModel.fromJson(r);
  //       CurrentUser.id = r['id'];
  //       List<String> ownerDetail = [
  //         r['id'].toString(),
  ...
  //     map['password'] = passwordtxt;
  //     var re = await ApiCall.createRecord(
  //         Uri.GET_COMPANY_EXECUTIVE + '/login', map,
  //         authorization: false);
  ...
  //       var r = await ApiCall.getDataFromApi(
  //           Uri.GET_COMPANY_EXECUTIVE + '/${re['companyExecutivId']}');
  //       SharedPref sharedPref = SharedPref();
  ...
  //           CurrentUser.notificationCount + re['notificationCountForNew'];
  ...
  //       print('done');
  //       List<String> executiveDetails = [
  //         re['companyExecutivId'].toString(),
  //         CurrentUser.ACCESS_TOKEN,
  //         re['ownerId'].toString(),
  //         re['companyId'].toString(),
  //         re['notificationCountToBeRead'].toString(),
  //         re['notificationCountForNew'].toString(),
  //         re['immediateStatusTicketCount'].toString(),
  //         re['highStatusTicketCount'].toString(),
  //         re['normalStatusTicketCount'].toString(),
  //         re['lowStatusTicketCount'].toString()
  //       ];
  ...
  @override
  void initState() {
    icon = const Icon(Icons.visibility_off, color: Color(0xff429dbe));
    super.initState();
  }
                                        ...
                                        child: Container(
                                          ...
                                          child: TextFormField(
                                            ...
                                            decoration: InputDecoration(
                                                ...
                                                hintText:
                                                    "Enter Secret key sent you to mail",
                                ...
                                child: Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () {
                                        ...
                                        //         builder: (c) {
                                        //           return AlertDialog(
                                        //               title: Text('Owner Added',
                                        //                   style: TextStyle(
                                        //                       color: Theme.of(
                                        //                               context)
                                        //                           .primaryColor)),
                                        //               content: Text(
                                        //                   'Congratulations.You have successfully registered as a new Owner.\nNow Sign In as a owner(Secret key is been sent to you by Email).'),
                                        //               actions: [
                                        //                 FlatButton(
                                        //                   child: Text('OK'),
                                        //                   onPressed: () {
